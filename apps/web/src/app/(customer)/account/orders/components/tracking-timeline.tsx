...
import { orderStatusConfig } from './order-status-confing'

interface TimelineProps {
  events: order_events[]
  currentStatus: OrderEventStatus | null
}
...
const TrackingTimeline: React.FC<TimelineProps> = ({
  events,
  currentStatus
}) => {
    ...
    <div className="relative">
      ...
      <div className="space-y-8">
        ...
        {steps.map((status, index) => {
          ...
          const event = lastEventByType[status]
          const isActive = currentStatus === status
          const isPassed =
            currentStatus &&
            steps.findIndex((s) => s === currentStatus) >= index
